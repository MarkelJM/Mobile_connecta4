...
class SquareBoard():
    ...
    def is_victory(self, char):
        return self._any_vertical_victory(char) or self._any_horizontal_vicotry(char) or self._any_rising_victory(char) or self._any_sinking_victory(char)
    ...
    def _any_horizontal_vicotry(self, char):
